        ...
        <div class="container flex flex-row items-center justify-between mx-auto">
            ...
            <div class="inline-flex items-center">
                ...
                <div class="relative flex items-center">
                    ...
                    <!-- Search icon -->
                    <input type="search"
                    class="relative m-0 pl-10 block w-full min-w-0 rounded border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:focus:border-primary"
    ...
    <footer class="p-4 text-white" style="background-color: #401111;">
        <div class="container flex flex-col items-center justify-between mx-auto md:flex-row">
            ...
            <div class="font-poppins">
                ...
                <p class="text-base"><a href="#">Login</a></p>
                <p class="text-base"><a href="#">Register</a></p>
            </div>
