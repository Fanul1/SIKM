...
<div class="flex items-center justify-between">
    ...
    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
        class="flex items-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-md text-sm px-3 py-1.5 text-center dark:bg-green-600 dark:hover-bg-green-700 dark:focus:ring-green-800"
        type="button">
            ...
            <div class="p-4 bg-white rounded-lg">
                <form>
                    ...
                    <div class="grid grid-cols-1 mt-2 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label for="numberphone" class="block text-sm font-medium leading-6 text-gray-900">Number
                                Phone</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Konfirmasi Kata
                                Sandi</label>
                            <div class="mt-2">
                                <input type="password" name="password" id="password" autocomplete="current-password"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
