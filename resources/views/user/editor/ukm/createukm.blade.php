...
<section class="bg-white dark:bg-gray-900">
    ...
    <form action="/createukm" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    <label for="akronim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kepanjangan
                        UKM</label>
                    <input type="text" name="akronim" id="akronim"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Ketik kepanjangan nama" required>
                </div>
                <div class="sm:col-span-2">
                    <label for="email"
                ...
                <div>
                    <label for="phone_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kontak
                        Telpon/WA (+62)</label>
