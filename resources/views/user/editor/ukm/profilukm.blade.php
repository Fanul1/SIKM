    ...
    <div class="max-w-6xl px-1 py-8 mx-auto lg:py-1">
        ...
        <form action="/updateukm" enctype="multipart/form-data" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    <label for="akronim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kepanjangan UKM</label>
                    <input type="text" name="akronim" id="akronim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required value="{{ old('name', $ukm->akronim) }}">
                </div>
                <div class="sm:col-span-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="avatar" type="file" accept="image/*" name="ukm_logo">
                ...
                <div class="relative sm:col-span-2">
                    ...
                    @if ($ukm->ukm_gambar)
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $ukm->ukm_gambar) }}" alt="Foto Sampul" class="object-cover max-w-sm rounded-lg">
                        </div>
                    @endif
                </div>                               
            </div>
